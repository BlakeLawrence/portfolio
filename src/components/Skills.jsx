    ...
    <div name="skills" className="w-full h-screen bg-[#0a192f]  text-gray-300">
      ...
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="pl-12 sm:pl-0 w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
          <div className="rounded-md shadow-md hover:shadow-md shadow-[#040c16] hover:shadow-[#1982C4] hover:scale-110 duration-500">
            <img
              src={Javascript}
              alt="javascript icon"
          ...
          <div className=" shadow-md rounded-md  border-[#1982C4] hover:shadow-md shadow-[#040c16] hover:shadow-[#1982C4] hover:scale-110 duration-500">
            <img
              src={postgresql}
              alt="postgresql icon"
              className="w-10 sm:w-20 mx-auto"
